...
export class CharacterActorSheet extends api.HandlebarsApplicationMixin(sheets.ActorSheet) {
    ...
    /**
     * Renders an embedded documents's sheet
     *
    ...
    /**
     * Fetches the embedded documents representing the containing HTML element
     *
     * @param {HTMLElement} target      The element subject to search
     * @returns {Item|ActiveEffect}     The embedded Item or ActiveEffect
     */
    _getEmbeddedDocument(target) {
        const docRow = target.closest("li[data-documents-class]");
        if (docRow.dataset.documentClass === "Item") {
            ...
            console.warn("Could not find documents class");
        }
    }
    ...
    /**
     * Submit a documents update based on the processed form data.
     * @param {SubmitEvent} event                   The originating form submission event
     * @param {HTMLFormElement} form                The form element that was submitted
     * @param {object} submitData                   Processed and validated form data to be used for a documents update
