...
export function prepareActiveEffectCategories(effects) {
    const categories = {
        temporary: {
            type: "temporary",
            label: game.i18n.localize("cyberhack.Effect.Temporary"),
            effects: []
        },
        passive: {
            type: "passive",
            label: game.i18n.localize("cyberhack.Effect.Passive"),
            effects: []
        },
        inactive: {
            type: "inactive",
            label: game.i18n.localize("cyberhack.Effect.Inactive"),
            effects: []
        }
    };
